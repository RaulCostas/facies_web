...
const idx = c.indexOf('## Manejo de Emergencia de la Bradicardia');
const nextIdx = c.indexOf('\n## ', idx + 1);

const newSection = `## Manejo de Emergencia de la Bradicardia
...
console.log('Bradycardia section updated!');
